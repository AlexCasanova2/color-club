alter table public.challenges
  add column color_selection_mode text not null default 'manual'
  check (color_selection_mode in ('manual', 'shared_random', 'individual_random'));

drop function if exists public.create_shared_challenge(uuid, text, public.duration_preset, timestamptz);
drop function if exists public.create_shared_challenge(uuid, text, public.duration_preset, timestamptz, smallint);
